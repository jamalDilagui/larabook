    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{'/update/'.$profils->id}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input id="titre" type="text" class="form-control" name="titre" value="{{ old('titre') ?? $profils->titre}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control" name="tof" value="{{ $profils->tof}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="url" type="text" class="form-control" value=" {{ $profils->url}}" name="url">
                            </div>
                        </div>
